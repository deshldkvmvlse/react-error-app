...
export default function App() {
  ...
  const [users, setUsers] = useState([
    { name: 'SURAJ', email: 'surajdeshmukh579@gmail.com' },
    { name: 'SHUBHAM', email: 'shubhamdeshmukh@hotmail.com' },
  ])
  ...
  const addUser = () => {
    setUsers(prev => [
      ...prev,
      { name: `User ${prev.length + 1}`, email: `user${prev.length + 1}@example.com` },
    ])
  }
        ...
        <div style={{ flex: '1', minWidth: '300px' }}>
          ...
          <ErrorBoundary>
            {showError ? (
              ...
              <UserProfile user={{ name: 'Suraj Deshmukh', email: 'surajdeshmukh579@gmail.com' }} />
            )}
          </ErrorBoundary>
        </div>
